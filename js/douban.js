    ...
    return new Promise((resolve, reject) => {
        ...
        setTimeout(() => {
            if (url.includes('type=movie')) {
                resolve({ tags: ['热门', '最新', '经典', '豆瓣高分'] });
            } else if (url.includes('type=tv')) {
                resolve({ tags: ['热门', '美剧', '韩剧', '日剧'] });
            } else if (url.includes('tag=动画')) {
                resolve({ tags: ['热门', '新番', '经典', '热血'] });
            } else if (url.includes('search_subjects')) {
                resolve({ subjects: [] });
            } else {
